...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cn2ctkbbprju.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'akgunblog' # please enter your s3 bucket name
